...
var propTypes = {
  ...
  selectedDays: _propTypes2.default.arrayOf(_reactMomentProptypes.momentObj), // Array of moment objects
  ...
  selectingMultipleRanges: _propTypes2.default.arrayOf(
    _reactMomentProptypes.momentObj
  ),
  selectMultipleRanges: _propTypes2.default.bool,
...
var Month = (function (_Component) {
  ...
  function Month(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Month.__proto__ || Object.getPrototypeOf(Month)).call(this, props)
    );
      ...
      value: function shouldComponentUpdate(nextProps) {
        ...
        if (this.props.selectRange) {
          if (selectingRange === undefined) {
            ...
            return (
              (_oldRangeStart <= month && month <= _oldRangeEnd) ||
              (_newRangeStart <= month && month <= _newRangeEnd)
            );
            ...
            return (
              (_oldRangeStart2 <= month && month <= _oldRangeEnd2) ||
              (_newRangeStart2 <= month && month <= _newRangeEnd2)
            );
          }
          // called on day hovering changed
    ...
    },
    {
      ...
      value: function renderMonthDays() {
        ...
        var _props3 = this.props,
          ...
          // new props for multiple ranges
          selectingMultipleRanges = _props3.selectingMultipleRanges,
          selectMultipleRanges = _props3.selectMultipleRanges,
          selectedRanges = _props3.selectedRanges;
        ...
        (0, _utils.range)(
          ...
          if (i <= prevMonthDaysCount) {
            ...
            if (selectMultipleRanges) {
              ...
              // Highlight currently selecting range
              if (
                selectingMultipleRanges &&
                selectingMultipleRanges.length === 2
              ) {
                var start = selectingMultipleRanges[0];
                var end = selectingMultipleRanges[1];
                if (end.isBefore(start)) {
                  var tmp = start;
                  start = end;
                  end = tmp;
          ...
          if (customClasses) {
            Object.keys(customClasses).forEach(function (k) {
              ...
              if (typeof obj === "string") {
                ...
                var endDate = (0, _moment2.default)(obj.end, "YYYY-MM-DD").add(
                  1,
                  "days"
                );
